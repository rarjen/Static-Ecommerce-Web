        ...
        <div class="pt-4">
          ...
          <div class="row total">
            ...
            <div class="col-md-6 buttons">
              <button type="button" class="btn btn-secondary"><a href="index.php">Home</a></button>
              <button type="button" class="btn btn-success"><a href="checkout.php">Checkout</a></button>
            </div>
          </div>
        </div>
      </div>
